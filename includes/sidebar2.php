<div class="az-sidebar">
	...
	<div class="az-sidebar-inner">
		<div class="az-banner">
			<img src="img/az-banner.jpg" alt="">
			<div class="az-banner-content">
				<span>Потолок</span><br>
				<span>своими руками</span><br>
				<a href="#">читать</a>
			</div>
		</div>
	</div>
	...
	<div class="az-zapisi">
		<div class="az-zapis az-zapis-border">
			...
			<div class="az-zapis-right">
				...
				<span class="az-zapis2 az-margin-top10">Деревянные</span>
			</div>
		...
		<div class="az-zapis az-zapis-border">
			...
			<div class="az-zapis-right">
				...
				<span class="az-zapis2 az-margin-top10">Крашенные</span>
			</div>
			<div class="clearfix"></div>
		</div>
		<div class="az-zapis">
			...
			<div class="az-zapis-right">
				...
				<span class="az-zapis2 az-margin-top10">Подвесные потолки</span>
			</div>
			<div class="clearfix"></div>
		</div>
	</div>
	<div class="az-title1 az-margin-top35">Комментарии</div>
	<div class="az-otziv">
		<div class="az-opros-text az-opros-text_style">Выполняется в случае, если площадь</div>
		<div class="az-otziv-inner">
			<div class="az-otziv-inner1"><img src="img/otziv-foto.png" alt=""><span>Виктория</span></div>
